...
\begin{comp}
\item Developed a Java code similarity detector that applies heuristics and aggregation at ByteCode level and does not require source code to identify plagiarism. Applied it to successfully identify plagiarised Java code. \textbf{Award}: \sref{MSc-ComputerEngineering-Award-BestMasterThesis.pdf}{Best Thesis}
\end{comp}
...
\item \sref{Course-Salamanca-Auditing.pdf}{Introduction to Information Systems Auditing} \textemdash{ }University of Salamanca, \DatestampY{2010}
...
\begin{comp}
\item \sref{Course-Udemy-AdvancedStableDiffusionWithComfyUIAndSDXL.pdf}{Advanced Stable Diffusion with ComfyUI and SDXL} \textemdash{ }Udemy / Pixovert Studio, \DatestampY{2024}
\item \sref{Course-Udemy-GenerativeAIMasteryWithComfyUISDXLandStableDiffusion.pdf}{Generative AI Mastery with ComfyUI SDXL and Stable Diffusion} \textemdash{ }Udemy / Pixovert Studio, \DatestampY{2024}
\end{comp}
\itemspacingtwo
...
\item \sref{Course-CalArts-ProgrammingMusicians.pdf}{Programming for Musicians and Digital Artists} \textemdash{ }Coursera / California Institute of the Arts, \DatestampY{2014}
\item \sref{Course-Udemy-GameMusicComposition.pdf}{Game Music Composition} \textemdash{ }Udemy, \DatestampY{2019}
\end{comp}
\itemspacingtwo
