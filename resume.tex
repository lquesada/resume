...
\textit{YouTube Infrastructure, Software Engineering} \textemdash{ }Engineering Manager (L7)
\begin{comp}
...
\textit{Cloud Artificial Intelligence, Site Reliability Engineering} \textemdash{ }Engineering Manager (L5 $\rightarrow$ L6 $\rightarrow$ L7)
\begin{comp}
...
\textit{Datacenter Software, Site Reliability Engineering} \textemdash{ }Technical Leader/Engineering Manager (L5)
\begin{comp}
\item Sped up efforts to revamp critical datacenter systems and landed them one year ahead of time
\end{comp}
\itemspacing

\textit{Apps Storage, Site Reliability Engineering} \textemdash{ }Technical Leader (L4 $\rightarrow$ L5)
\begin{comp}
...
\textit{Department of Computer Science and Artificial Intelligence} \textemdash{ }Fellow, University Lecturer in Training
\begin{comp}
