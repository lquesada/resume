...
\begin{comp}
\item Reengineered large-scale pipelines, improved performance \textbf{1000x}. \textbf{Award}: \sref{Google-Award-PerformanceExcellence.pdf}{Performance Excellence}
...
\begin{comp}
\item Directed the productionization of 3 flagship products, unlocking \textbf{\$1B+} revenue.
...
\newpage
\renewcommand{\baselinestretch}{1.045}\selectfont
...
Achieved \textbf{800K downloads} and \textbf{1.1K GitHub stars}. \SmallEntryGap
...
Developed an Android application for amateur radio FT8 digital mode communication with a portable transceiver. Offers a feature-rich yet intuitive interface, a web server for remote control, and complete integration with logbook services. \SmallEntryGap
...
Achieved \textbf{60K streams}. \SmallEntryGap
