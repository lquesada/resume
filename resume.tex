...
\item Developed infrastructure to run Large Language Models and integrated them to significantly increase the expressiveness of existing tooling.
\end{comp}
\itemspacing
...
\textbf{Cybersecurity}
\begin{comp}
\item CERTYRED professional certification on security \textemdash{ }University of Salamanca, \DatestampY{2011}
...
\item Developed a \href{https://github.com/lquesada/PiticliSim}{mini-game} the the Voxatron virtual voxel-based console
\end{comp}
\itemspacingtwo
