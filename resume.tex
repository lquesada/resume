...
\item Developed a set of ComfyUI nodes for \href{https://registry.comfy.org/nodes/comfyui-inpaint-cropandstitch}{inpainting with generative models}, automating complex image manipulation workflows and improving prompt adherence and output quality.
    \newline Achieved \textbf{420K downloads} and \textbf{900 GitHub stars}.
\end{comp}
\itemspacingtwo
...
\begin{comp}
\item Designed a technique for 3 degrees-of-freedom \href{https://doi.org/10.1142/S0129065712500190}{motion tracking} with a single low-budget camera.
\end{comp}
\itemspacingtwo
