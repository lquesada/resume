	...
	\begin{comp}
	\item Developed ComfyUI nodes for \href{https://registry.comfy.org/nodes/comfyui-inpaint-cropandstitch}{inpainting}. Achieved \textbf{700K downloads} and \textbf{1K GitHub stars}.
\end{comp}
\itemspacingtwo
...
\item Developed an \href{https://qft8.com}{FT8 digital mode Android application}. Achieved \textbf{800 downloads}.
\end{comp}
\itemspacingtwo
