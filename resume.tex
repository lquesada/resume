...
\item Developed a set of ComfyUI nodes for \href{https://registry.comfy.org/nodes/comfyui-inpaint-cropandstitch}{inpainting with generative models}, automating complex image manipulation workflows and improving prompt adherence and output quality.
   \newline Achieved \textbf{515K downloads} and \textbf{950 GitHub stars}.
\end{comp}
\itemspacingtwo
...
\textbf{Amateur Radio}
\begin{comp}
\item Held data handshakes up to \href{https://raw.githubusercontent.com/lquesada/radio\_stuff/refs/heads/main/farthestqso.png}{9967 km} away, copied an astronaut in the \href{https://www.youtube.com/watch?v=tkVmO62aYzk}{International Space Station}
