...
\begin{comp}
\item Developed a set of ComfyUI nodes for \href{https://registry.comfy.org/nodes/comfyui-inpaint-cropandstitch}{inpainting with generative models}, that improve prompt adherence and output quality. Achieved \textbf{640K downloads} and \textbf{1K GitHub stars}.
\end{comp}
\itemspacingtwo
...
\item Developed an \href{https://qft8.com}{FT8 digital mode Android application}. Achieved \textbf{400 downloads}.
\end{comp}
\itemspacingtwo
...
\item Produced \href{https://open.spotify.com/artist/6GdiI8ZKeWhSY73WWOhbep}{alternative rock albums} leveraging artificial intelligence. Achieved \textbf{50K streams}.
\end{comp}
