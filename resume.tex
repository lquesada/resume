...
\item Extended an internal product with generalization and a customization framework to streamline onboarding of new use cases with limited engineering effort.
\item Developed infrastructure to run Large Language Models and integrated them to significantly increase the expressiveness of existing tooling. \textbf{Award}: Feature Excellence
\end{comp}
\itemspacing
...
\begin{comp}
\item Improved the availability and efficiency of a widely-used internal storage system by implementing an A/B-testing solution to detect regressions and integrating it in the rollout automation with push-on-green and alerting capabilities.
\item Responsible for the resource provisioning and capacity management of the storage backends of products with >1B external users. Developed, tested, and deployed a forecasting and provisioning model that led to significant resource savings and increased reliability. \textbf{Award}:\hspace{0.1cm}Feats of Engineering
...
\item Directed a Master Thesis on a language for music prototyping. \textbf{Award}: Best Thesis (as director)
...
\item Mentored two students doing software engineering internships at companies.
\end{comp}
...
\begin{comp}
\item Developed lexical analyzers and parsers with ambiguity support.
\end{comp}
\phantom{g}\textit{Bachelor of Science, Information Systems Engineering}. GPA 8.7/10. \textbf{Award}: First of Class\newline
\phantom{g}\textit{Master of Science, Computer Science}. GPA 9.2/10. \textbf{Awards}: First of Class, National Award, Honors
\begin{comp}
\item Developed a Java code similarity detector that applies heuristics and aggregation at ByteCode level and does not require source code to identify plagiarism. Applied it to successfully identify plagiarised Java code. \textbf{Award}: Best Thesis
\end{comp}
...
\textbf{Cybersecurity}
\begin{comp}
\item CERTYRED Professional Certificate on Security \textemdash{ }University of Salamanca, \DatestampY{2011}
\item Introduction to Information Systems Auditing \textemdash{ }University of Salamanca, \DatestampY{2010}
\item Security of Networked Information Systems \textemdash{ }University of Granada, \DatestampY{2010}
\end{comp}
\itemspacingtwo

\textbf{Generative Artificial Intelligence}
\begin{comp}
\item Advanced Stable Diffusion with ComfyUI and SDXL \textemdash{ }Udemy / Pixovert Studio, \DatestampY{2024}
\item Generative AI Mastery with ComfyUI SDXL and Stable Diffusion \textemdash{ }Udemy / Pixovert Studio, \DatestampY{2024}
\end{comp}
\itemspacingtwo

\textbf{User Experience}
\begin{comp}
\item Professional Certificate on User Experience Design \textemdash{ }Coursera / Google, \DatestampY{2024}
\end{comp}
\itemspacingtwo

\textbf{Music}
\begin{comp}
\item Grade 5 Music Theory \textemdash{ }The Associated Board of the Royal Schools of Music, \DatestampY{2013}
\item Grade 4 Singing \textemdash{ }The Associated Board of the Royal Schools of Music, \DatestampY{2013}
\item Modern Musician Specialization \textemdash{ }Coursera / Berklee College of Music, \DatestampY{2014}
\item Programming for Musicians and Digital Artists \textemdash{ }Coursera / California Institute of the Arts, \DatestampY{2014}
\item Game Music Composition \textemdash{ }Udemy, \DatestampY{2019}
\end{comp}
\itemspacingtwo
...
\item Developed ComfyUI nodes for \href{https://github.com/lquesada/ComfyUI-Interactive}{interactive UI}
