...
\item Architected the technical strategy for \textbf{5} core production areas (capacity, monitoring, rollouts, data integrity, frameworks) spanning \textbf{1K+} engineers and \textbf{50+} products, and led \textbf{70} engineers to execute. Delivered savings of \textbf{\$XXXM+} in computing resources and significantly improved product reliability. \textbf{Awards}: \sref{Google-Award-GoogleCloudTechImpact-2022.pdf}{Cloud} + \sref{Google-Award-CoreTechImpact-2021.pdf}{Core} + \sref{Google-Award-GoogleTechImpact-2022.pdf}{Google} Tech Impact, \sref{Google-Award-Perfy.pdf}{Perfy}, \sref{Google-Award-TechDebtBusters1.pdf}{Tech Debt Busters} x\sref{Google-Award-TechDebtBusters2.pdf}{2}
\end{comp}
\itemspacing
