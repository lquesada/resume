...
\begin{comp}
\item Developed a set of ComfyUI nodes for \href{https://registry.comfy.org/nodes/comfyui-inpaint-cropandstitch}{inpainting with generative models}, that improve prompt adherence and output quality. Achieved \textbf{610K downloads} and \textbf{1000 GitHub stars}.
\end{comp}
\itemspacingtwo
...
\begin{comp}
\item Developed a \href{https://github.com/lquesada/LifoSource}{web-based multiplayer videogame}. Achieved \textbf{10K monthly active users} in the 2000s.
...
\textbf{Amateur Radio}
\begin{comp}
\item Held data handshakes up to \href{https://raw.githubusercontent.com/lquesada/radio\_stuff/refs/heads/main/farthestqso.png}{9967 km} away, received an astronaut in the \href{https://www.youtube.com/watch?v=tkVmO62aYzk}{International Space Station}.
\item Developed an \href{https://qft8.com}{FT8 digital mode Android application}. Achieved \textbf{300 downloads}.
\end{comp}
\itemspacingtwo

\textbf{Computer-Aided Design}
\begin{comp}
\item Designed a \href{https://cad.onshape.com/documents/6f311a10ec51aa3537802148/w/56b352678d688f442bcec21d/e/27757cddc438c8a224282e5c}{parameterized velcro stand 3d printer model}. Example: \href{https://www.printables.com/model/1638498-whizz-loop-velcro-stand}{Whizz Loop antenna}.
\end{comp}
\itemspacingtwo
...
\textbf{Literature}
\begin{comp}
\item Authored \href{https://www.amazon.es/dp/B0C4DVR9N5}{Spanish books for children}. Achieved \textbf{20K downloads} and a \textbf{4.3/5 rating} in \textbf{1K reviews}.
\end{comp}
\itemspacingtwo

\textbf{Music}
\begin{comp}
\item Produced \href{https://open.spotify.com/artist/3RPEdOJGGdk3kOnmVq3dgX}{indie rock, synthesizer, and piano albums}. Achieved \textbf{20K streams}.
\item Produced \href{https://open.spotify.com/artist/6GdiI8ZKeWhSY73WWOhbep}{alternative rock albums} leveraging artificial intelligence. Achieved \textbf{40K streams}.
\end{comp}
