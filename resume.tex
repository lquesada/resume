...
\begin{comp}
\item Developed a set of ComfyUI nodes for \href{https://registry.comfy.org/nodes/comfyui-inpaint-cropandstitch}{inpainting with generative models}, that improve prompt adherence and output quality. Achieved \textbf{610K downloads} and \textbf{990 GitHub stars}.
\end{comp}
\itemspacingtwo
