...
\normalsize{\href{https://luisquesada.com}{luisquesada.com} | \href{http://github.com/lquesada}{github.com/lquesada}}\par
...
Achieved \textbf{740K downloads} and \textbf{1.1K GitHub stars}. \SmallEntryGap
...
Achieved \textbf{800 monthly users} and a rating of \textbf{4.7/5}. \SmallEntryGap
...
Achieved \textbf{100 monthly users} and a rating of \textbf{4.9/5}. \SmallEntryGap
...
Developed an Android Morse code practice keyer. Features support for both on-screen and external hardware paddles, several keyer algorithms, a highly configurable user interface, ultra-low latency with minimal jitter, and transmission and reception training games. \SmallEntryGap
Achieved \textbf{100 monthly users} and a rating of \textbf{4.6/5}. \SmallEntryGap
